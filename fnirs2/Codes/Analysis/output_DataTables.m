...
filename = [Data.Path.study_path filesep 'Processed' filesep sub filesep 'WCOHresults_' num2str(F1) '_' num2str(F2) 'Hz.csv'];
...
filename = [Data.Path.study_path filesep 'Processed' filesep sub filesep 'Powerresults_' num2str(F1) '_' num2str(F2) 'Hz.csv'];
writetable(m,filename); % write to csv
clear m
...
% write to csv
 ...
 if exist('m')
    ...
    m = array2table(m,'VariableNames',header_string);
    filename = [Data.Path.study_path filesep 'Processed' filesep sub filesep 'Phaseresults_' num2str(F1) '_' num2str(F2) 'Hz.csv'];
    writetable(m,filename); % write to csv
 end
