function PostAnalysis_CD(Data)
    ...
    for rc = 1:length(regionLabels)
        ...
        for S_count = 1:length(Data.SOI)
            ...
            procFile = ([Data.Path.study_path filesep 'Processed' filesep sub]);
            load([procFile filesep 'Preprocessing' filesep 'Processed.mat']);
            
            if ~exist([procFile filesep 'Analysis'])
                mkdir([procFile filesep 'Analysis']);
            end
            ...
            if exist(WFile)
                ...
                filePath = [procFile filesep 'Analysis' filesep char(regionLabels(rc)) '_'];
